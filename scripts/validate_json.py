...
def main()->int:
    ...
    articles=load_json('articles.json',[]); promotions=load_json('promotions.json',[]); events=load_json('events.json',[]); bouts=load_json('bouts.json',[]); fighters=load_json('fighters.json',[]); titles=load_json('titles.json',[]); snapshots=load_json('fighter_snapshots.json',[]); aliases=load_json('aliases.json',{}); load_json('metadata.json',{})
    ...
    validate_bouts(bouts,event_ids,promotion_ids,fighter_ids,article_ids); validate_titles(titles,promotion_ids,fighter_ids,article_ids); validate_fighter_snapshots(snapshots,fighter_ids,event_ids,article_ids,promotion_ids); validate_aliases(aliases)
