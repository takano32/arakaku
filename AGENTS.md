...
4. Render the site from those JSON files, supplementing missing or unknown fields with comparison data (e.g., Apple Numbers) via the viewer's `DataRepository`.
